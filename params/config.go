...
type ChainConfig struct {
	/**
	指定了独立的区块链网络 ID。网络 ID 在连接到其他节点的时候会用到，以太坊公网的网络 ID 是 1，为了不与公有链网络冲突，
	运行私有链节点的时候要指定自己的网络 ID。不同 ID 网络的节点无法相互连接。
	 */
...
type CliqueConfig struct {
	...
	//即每当区块链的高度为30000的整数倍时，到达Epoch时间点
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint  //Epoch:时代
}

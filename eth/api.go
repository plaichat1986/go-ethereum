...
func (api *PrivateMinerAPI) Start(threads *int) error {
	...
	if !api.e.IsMining() {//Ethereum.miner.mining
		// Propagate the initial price point to the transaction pool
		api.e.lock.RLock()
		price := api.e.gasPrice //e:Ethereum
		api.e.lock.RUnlock()
		fmt.Printf("test api.go Start price = %s\n", price)
		api.e.txPool.SetGasPrice(price) //update txPool's tx(price below will be remove)
